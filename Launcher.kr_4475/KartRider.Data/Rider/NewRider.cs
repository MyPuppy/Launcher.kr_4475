...
namespace RiderData
{
    public static class NewRider
    {
        ...
        {
            NewRider.Kart_X_Cut = 36;
            NewRider.Kart_Old_Cut = 290;
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= NewRider.MaxKart; i++)
                {
                    if (i <= 25 || i == 27 || i == 29 || i == 45 || i == 54 || i == 59 ||
                        ...
                        i == 1094 || i == 1095 || i == 1098 || i == 1103 || i == 1137 || //old

                        i == 1096 || i == 1097 || i == 1107 || i == 1108 || i == 1112 || i == 1114 || i == 1118 || i == 1119 || i == 1121 || i == 1122 || i == 1123 || i == 1124 || i == 1125 || i == 1126 || i == 1129 ||
                        i == 1131 || i == 1132 || i == 1133 || i == 1135 || i == 1136 || i == 1140 || i == 1144 || i == 1145 || i == 1148 || i == 1159 || i == 1160 || i == 1163 || i == 1167 || i == 1168 || i == 1169 ||
                        i == 1170 || i == 1171 || i == 1173 || i == 1174 || i == 1175 || i == 1176) //X
                    {
        ...
        public static void Character()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int Character = 293;
                oPacket.WriteInt(Character - 33 - 29);
                for (short i = 1; i <= Character; i++)//Character
                {
                    if (i == 47 || i == 48 || i == 63 || i == 116 || i == 117 || i == 124 || i == 128 || i == 130 || i == 134 || i == 137 ||
                        ...
                        i == 194 || i == 195 || i == 196 || i == 197 || i == 231 || i == 239 || i == 245 || i == 246 || i == 247 || i == 257 || 
                        i == 265 || i == 288 || i == 292 ||

                        i == 33 || i == 34 || i == 35 || i == 36 || i == 45 || i == 52 || i == 56 || i == 57 || i == 58 || i == 59 ||
                        i == 67 || i == 70 || i == 79 || i == 80 || i == 83 || i == 85 || i == 110 || i == 112 || i == 121 || i == 126 ||
                        i == 132 || i == 152 || i == 155 || i == 162 || i == 185 || i == 203 || i == 233 || i == 269 || i == 286)
                    {
                    }
                    else
                    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= Pet; i++)
                {
                    if (i == 8 || i == 10 || i == 11 || i == 14 || i == 18 || i == 50 || i == 77 || i == 85 || i == 91 || i == 92 || 
                        i == 105 || i == 107 || i == 120 || i == 129 || i == 136 || i == 143 || i == 152 || i == 153)
                    {
                    }
                    else
                    {
        ...
        public static void FlyingPet()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                {
                    if (i == 20 || i == 21 || i == 22 || i == 23 || i == 24 || i == 52)
                    {
                    }
                    else
                    {
        ...
        public static void Aura()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                {
                    if (i == 28 || i == 33 || i == 35 || i == 46 || i == 53 || i == 54 || i == 58 || i == 59 || i == 76 || i == 78 || i == 89)
                    {
                    }
                    else
                    {
            ...
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                for (short i = 1; i <= HeadBand; i++)
                {
                    if (i == 16 || i == 21 || i == 23 || i == 29 || i == 37 || i == 39 || i == 40 || i == 41 || i == 43 || i == 44 ||
                        ...
                        i == 503 || i == 506 || i == 527 || i == 529 || i == 531 || i == 551)
                    {
                    }
                    else
                    {
        ...
        public static void HandGearL()
        {
            using (OutPacket oPacket = new OutPacket("LoRpGetRiderItemPacket"))
            {
                ...
                oPacket.WriteInt(1);
                int HandGearL = 370;
                oPacket.WriteInt(HandGearL + 6 - 80);
